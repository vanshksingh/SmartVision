...
2. Expiry date
3. Package size
Provide the output strictly in JSON format with keys 'brand_name', 'expiry_date', and 'package_size'. Do not include any additional text, explanations, or formatting. If any of these details are missing, set their values to "Unknown". Package size can be in any format like net weight 1kg, 500g, etc."""
...
def process_images(image_paths: list) -> dict:
    """
    Process multiple images to extract product details.
...
if __name__ == "__main__":
    # Example usage with two images (front and back)
    front_image_path = "/Users/vanshkumarsingh/Desktop/front.png"  # Replace with your front image path
    back_image_path = "/Users/vanshkumarsingh/Desktop/back.png"    # Replace with your back image path

    # List of image paths
    image_paths = [front_image_path, back_image_path]

    # Uncomment the following lines to use only one image
    # image_paths = [front_image_path]

    # Process the images and get the product details
    product_details = process_images(image_paths)
